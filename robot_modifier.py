...
#         - 'FLR' с выключенным модификатором
#         - "FLR0123456789!" с включенным модификатором
# 2) Регистр не важен
# 3) Нельзя заканчивать команду на цифру
# 4) Нельзя начинать команду с "!"
# 5) Число обязано стоять только перед символами "F", "R", "L"
# 6) "!" обязан стоять только после символа "F"
# 7) Максимальное число - 999
# 8) "!" после "F" означает, что след робота, будет невидимым. Другими словами можно назвать прыжком
